...
export default function MovieCard({movie, ind , toggleBookmark ,page}:{movie:movie,ind:number,toggleBookmark: (movie:movie)=>void , page:string}) {
        ...
        <div>
            <div className=' self-start flex gap-3 text-xs font-light'>
                ...
                <span className='flex gap-1'>
                    <span>&bull;</span>
                    {(page==='movies')?(<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
